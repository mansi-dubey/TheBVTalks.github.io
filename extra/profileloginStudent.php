               ...
               <li><a href="../index.html" class="store">Home</a></li>
                     <!-- <li class="menu-item"><a href="#" class="store">Faculty</a>
                        <ul class="drop-menu">
                            ...
                            <li class="drop-menu-item"><a href="#">MATHEMATICS AND COMPUTING</a></li>
                    ...
                    <ul class="drop-menu">
                            ...
                            <li class="drop-menu-item"><a href="#">COMPUTER SCIENCE</a></li>
                    ...
                    <div class="profile">
                        ...
                        <a href="Student_Profile.php" class="butn" value="<?php echo $_SESSION['name']?>">View Profile</a>
                        <div class="flex-btn">
